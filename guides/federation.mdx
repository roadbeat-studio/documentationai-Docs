...
## Pro Features (Plugin: pro-activitypub)

<Callout kind="info">
  The **pro-activitypub** plugin (P10) extends the Federation Gateway with advanced capabilities for high-volume publishers. It requires the Pro license tier.
</Callout>
