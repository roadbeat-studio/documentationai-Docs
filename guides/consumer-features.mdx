...
- **Popup cards** — clicking a marker opens a vertical popup card matching the teaser grid card design: full-width hero image, content type badge, publisher name, title (2-line clamp), description (2-line clamp), and a footer with publication date and info/bookmark action buttons.
...
- **Custom emoji markers** — each content type has a distinct marker: colored circular pin with a white background, content-type-specific border color, and an emoji icon (e.g., 🎉 Event, 📰 News, 🎪 Festival, 💼 Job, 🍳 Recipe, 🏠 Property, 🎓 Course, 🛍️ Product). Markers scale up on hover with a smooth transition.
- **Popup cards** — clicking a marker opens a compact card popup with:
  ...
  - Content type badge (outlined style) and publisher name
...
| Content Type | Color | Icon |
|---|---|---|
| **News** | Blue (`#3b82f6`) | 📰 |
| **Blog Post** | Blue (`#3b82f6`) | ✍️ |
| **Event** | Purple (`#8b5cf6`) | 🎉 |
| **Festival & Fair** | Purple (`#a855f7`) | 🎪 |
| **Job** | Green (`#22c55e`) | 💼 |
| **Recipe** | Orange (`#f97316`) | 🍳 |
| **Real Estate** | Rose (`#e11d48`) | 🏠 |
| **Course** | Cyan (`#06b6d4`) | 🎓 |
| **Product** | Yellow (`#eab308`) | 🛍️ |
