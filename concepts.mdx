...
Studio is **multi-tenant** at the data level. Each installation has one organization, and all content, users, and assets belong to that organization. Users are assigned roles within the organization.

## Roles

CE provides three built-in roles:

| Role | Permissions |
|------|------------|
| **Admin** | Full access — users, settings, content, publishing |
